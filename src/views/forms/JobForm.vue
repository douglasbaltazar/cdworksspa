    ...
    <div class="row">
      ...
      <div class="col-12">
        ...
        >
          ...
          >
            <b-form-invalid-feedback
              :state="
                $v.form.description.$dirty ? !$v.form.description.$error : null
              "
            >
      ...
      <div class="col-12">
        ...
        >
          ...
          >
            <div class="row" v-if="skills">
              <div
                ...
                :key="skill.id"
              >
                <b-form-checkbox :value="skill.id">{{
                  skill.name
                }}</b-form-checkbox>
              </div>
            </div>
          ...
          >
            Pelo menos uma habilidade deve ser selecionada.
          </b-form-invalid-feedback>
        </b-form-group>
      </div>
...
export default {
  ...
  async mounted() {
    const responseSkills = await apiProtected.get("skills/");
