        ...
        <b-form v-if="show" @reset.prevent="onReset()" @submit.prevent="onSubmit()">
          ...
          >
            <b-form-input
              ...
              placeholder="Informe seu Email completo"
            ></b-form-input>
    ...
    async onSubmit() {
        try {
            ...
            if(this.form.passwordConfirmation !== this.form.password) {
                this.error.message = "As senhas não conferem"
                this.error.password.state = false;
                this.error.password.message = "Os valores não são iguais"
                return;
            }
            ...
            console.log(error);
            this.error.message = "Não foi possivel concluir o cadastro"
