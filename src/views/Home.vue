      ...
      <div class="row">
        <div class="col-12 col-sm-6 pb-2">
          <b-card
            ...
            sub-title="Busque um novo projeto"
          >
            <b-card-text>
              Trabalhe em projetos interessantes que você realmente deseja
              trabalhar.
            </b-card-text>
            <router-link
              to="/register"
              class="card-link text-white btn btn-primary"
        ...
        <div class="col-12 col-sm-6 pb-2">
          <b-card
            ...
            text-variant="black"
            title="Busco Freelancer"
            sub-title="Cadastre o seu novo projeto"
          >
            <b-card-text>
              Venha para nossa plataforma e entre em contato com os melhores devs.
            </b-card-text>
            <router-link
              to="/register"
              class="card-link text-white btn btn-danger"
              >Cadastrar-se</router-link
            >
          </b-card>
        </div>
